...
export default function ComplianceStandardsPage() {
  return (
    <ServiceDetail
      ...
      problem="Many companies struggle to organize project information. Files get lost, teams can't find what they need, and you can't prove you're following industry standards. This creates legal risks and wastes time and money."
      ...
      workflow={[
        ...
        },
        {
          ...
          description: 'We regularly check that you're following the standards and help you get certified if needed.',
        },
      ]}
      deliverables={[
        'Implementation Plan',
